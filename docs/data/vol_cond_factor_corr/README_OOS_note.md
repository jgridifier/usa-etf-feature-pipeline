...
## Quant gate (2026-09-21 ET)

**FAIL / ARCHIVE — do not cut into books.** Every trial NW t vs Book-2 VT is negative; no Sharpe beat of unconditional Book-2. Live shortlist stays static core + unconditional Book-2 VT. See Methods Archive scoreboard.
